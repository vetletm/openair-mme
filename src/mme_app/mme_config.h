...
#define MME_CONFIG_STRING_MME_MOBILITY_COMPLETION_TIMER \
  "MME_MOBILITY_COMPLETION_TIMER"
#define MME_CONFIG_STRING_MME_S10_HANDOVER_COMPLETION_TIMER \
  "MME_S10_HANDOVER_COMPLETION_TIMER"
...
#define MME_CONFIG_STRING_DUMMY_HANDOVER_FORWARDING_ENABLED \
  "DUMMY_HANDOVER_FORWARDING_ENABLED"
...
#define MME_CONFIG_STRING_NAS_STRICT_FILLER_BITS_CHECK \
  "STRICT_FILLER_BITS_CHECK"
...
typedef enum { RUN_MODE_BASIC, RUN_MODE_SCENARIO_PLAYER } run_mode_t;
...
#define MME_CONFIG_MAX_SERVICE 128
    ...
    union {
      struct sockaddr_in v4;  //   service_ip_addr[MME_CONFIG_MAX_SERVICE]; /**<
                              //   Just allocating sockaddr was not enough. */
      struct sockaddr_in6
          v6;  //; /**< Just allocating sockaddr was not enough. */
